...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'hero-pattern': 'linear-gradient(180deg, #050816 0%, #0a0a12 50%, #050816 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        'glow-pulse': { '0%, 100%': { boxShadow: '0 0 20px hsla(173 80% 60% / 0.3)' }, '50%': { boxShadow: '0 0 40px hsla(173 80% 60% / 0.6)' } },
